...
public class PromHolder {
    ...
    public PromHolder() {
        Texture texture0 = new Texture("prom-line.png");
        Texture texture1 = new Texture("prom-point.png");
        ...
        lineEntity.add(new PositionComponent(SCREEN_WIDTH/2, SCREEN_HEIGHT - 72));
    ...
    public int addPoint(){
        ...
        pointEntity.add(new PositionComponent(80 + list.size()*36, SCREEN_HEIGHT - 72));
